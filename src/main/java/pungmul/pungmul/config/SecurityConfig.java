    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/api/member/clubs","/api/member/signup/**", "/api/member/login","/api/member/refresh","/api/member/kakao/**","/ws/**","/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html").permitAll()
