...
//
//        WebSocketSession recipientSession = sessionMap.get(chatMessage.getReceiverUsername());
//        if (recipientSession != null && recipientSession.isOpen()) {
//            recipientSession.sendMessage(new TextMessage(mapper.writeValueAsString(chatMessage)));
//        } else {
//            log.error("User {} is not connected", chatMessage.getReceiverUsername());
//        }
//    }
//
//    @Override
...
//        WebSocketSession recipientSession = sessionMap.get(message.getReceiverUsername());
//        if (recipientSession != null && recipientSession.isOpen()) {
//            try {
//                String jsonMessage = mapper.writeValueAsString(message);
//                recipientSession.sendMessage(new TextMessage(jsonMessage));
//                log.info("Message sent to user {}", message.getReceiverUsername());
//                return true;
//            } catch (IOException e) {
//                log.error("Error sending message to user {}", message.getReceiverUsername(), e);
//            }
//        } else {
//            log.error("User {} is not connected", message.getReceiverUsername());
//        }
//        return false;
//    }
//
